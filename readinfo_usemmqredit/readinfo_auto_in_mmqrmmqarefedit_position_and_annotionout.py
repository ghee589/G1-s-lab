...
####################################################################################################
	...
	return [(x, y), ("srn : " + str(supporting_reads_num)), ("mmqa : " + str(mean_mappingQ_altreads)), ("mmqr : " + str(mean_mappingQ_refreads)), ("absmqar : " + str(mean_mappingQ_refreads - mean_mappingQ_altreads)), ("mmisar : " + str(mean_mismatch_altreads)), ("psoft : " + str(percent_soft_clipped_sum))]
