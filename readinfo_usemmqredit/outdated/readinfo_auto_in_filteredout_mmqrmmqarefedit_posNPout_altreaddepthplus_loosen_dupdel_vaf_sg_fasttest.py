...
def result(x, y, ls):
	...
	return str(round(supporting_reads_num, 3)) + "\t" + str(round((mean_mappingQ_refreads - mean_mappingQ_altreads), 3)) + "\t" + str(round(mean_mappingQ_altreads, 3)) + "\t" + str(round(mean_mappingQ_refreads, 3)) + "\t" +  str(round(mean_mismatch_altreads, 3)) + "\t" + str(round(percent_soft_clipped_sum, 3))
