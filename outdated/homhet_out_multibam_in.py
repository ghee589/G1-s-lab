...
for j in range(len(variant_list)):
	print(str(chrompos[j]) +  "\t"  + str(VAFcal(bam1, chrompos[j])) + "\t" + str(VAFcal(bam2, chrompos[j])) +"\t" + str(VAFcal(bam3, chrompos[j])) +"\t" + str(VAFcal(bam4, chrompos[j])) +"\t" + str(VAFcal(bam5, chrompos[j])) +"\t" + str(VAFcal(bam6, chrompos[j])) +"\t" + str(VAFcal(bam7, chrompos[j])) +"\t" + str(VAFcal(bam8, chrompos[j])) +"\t" + str(VAFcal(bam9, chrompos[j])) +"\t" + str(VAFcal(bam10, chrompos[j])))
