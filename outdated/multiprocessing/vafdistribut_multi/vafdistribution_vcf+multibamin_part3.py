...
chrompos_3 = chrompos_split[2]

for j in range(len(chrompos_3)):
		print(str(tuple(chrompos_3[j])) +  "\t"  + str(VAFcal(bam1, chrompos_3[j])) + "\t" + str(VAFcal(bam2, chrompos_3[j])) +"\t" + str(VAFcal(bam3, chrompos_3[j])) +"\t" + str(VAFcal(bam4, chrompos_3[j])) +"\t" + str(VAFcal(bam5, chrompos_3[j])) +"\t" + str(VAFcal(bam6, chrompos_3[j])) +"\t" + str(VAFcal(bam7, chrompos_3[j])) +"\t" + str(VAFcal(bam8, chrompos_3[j])) +"\t" + str(VAFcal(bam9, chrompos_3[j])) +"\t" + str(VAFcal(bam10, chrompos_3[j])))