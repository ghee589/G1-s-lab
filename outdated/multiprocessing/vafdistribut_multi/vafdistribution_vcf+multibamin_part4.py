...
chrompos_4 = chrompos_split[3]

for j in range(len(chrompos_4)):
	print(str(tuple(chrompos_4[j])) +  "\t"  + str(VAFcal(bam1, chrompos_4[j])) + "\t" + str(VAFcal(bam2, chrompos_4[j])) +"\t" + str(VAFcal(bam3, chrompos_4[j])) +"\t" + str(VAFcal(bam4, chrompos_4[j])) +"\t" + str(VAFcal(bam5, chrompos_4[j])) +"\t" + str(VAFcal(bam6, chrompos_4[j])) +"\t" + str(VAFcal(bam7, chrompos_4[j])) +"\t" + str(VAFcal(bam8, chrompos_4[j])) +"\t" + str(VAFcal(bam9, chrompos_4[j])) +"\t" + str(VAFcal(bam10, chrompos_4[j])))