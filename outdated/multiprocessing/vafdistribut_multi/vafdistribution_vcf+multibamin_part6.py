...
for j in range(len(chrompos_6)):
	print(str(tuple(chrompos_6[j])) +  "\t"  + str(VAFcal(bam1, chrompos_6[j])) + "\t" + str(VAFcal(bam2, chrompos_6[j])) +"\t" + str(VAFcal(bam3, chrompos_6[j])) +"\t" + str(VAFcal(bam4, chrompos_6[j])) +"\t" + str(VAFcal(bam5, chrompos_6[j])) +"\t" + str(VAFcal(bam6, chrompos_6[j])) +"\t" + str(VAFcal(bam7, chrompos_6[j])) +"\t" + str(VAFcal(bam8, chrompos_6[j])) +"\t" + str(VAFcal(bam9, chrompos_6[j])) +"\t" + str(VAFcal(bam10, chrompos_6[j])))
