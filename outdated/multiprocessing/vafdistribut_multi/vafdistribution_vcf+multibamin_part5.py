...
chrompos_5 = chrompos_split[4]

for j in range(len(chrompos_5)):
	print(str(tuple(chrompos_5[j])) +  "\t"  + str(VAFcal(bam1, chrompos_5[j])) + "\t" + str(VAFcal(bam2, chrompos_5[j])) +"\t" + str(VAFcal(bam3, chrompos_5[j])) +"\t" + str(VAFcal(bam4, chrompos_5[j])) +"\t" + str(VAFcal(bam5, chrompos_5[j])) +"\t" + str(VAFcal(bam6, chrompos_5[j])) +"\t" + str(VAFcal(bam7, chrompos_5[j])) +"\t" + str(VAFcal(bam8, chrompos_5[j])) +"\t" + str(VAFcal(bam9, chrompos_5[j])) +"\t" + str(VAFcal(bam10, chrompos_5[j])))	