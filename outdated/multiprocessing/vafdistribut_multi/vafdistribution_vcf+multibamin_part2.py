...
chrompos_2 = chrompos_split[1]

for j in range(len(chrompos_2)):
	print(str(tuple(chrompos_2[j])) +  "\t"  + str(VAFcal(bam1, chrompos_2[j])) + "\t" + str(VAFcal(bam2, chrompos_2[j])) +"\t" + str(VAFcal(bam3, chrompos_2[j])) +"\t" + str(VAFcal(bam4, chrompos_2[j])) +"\t" + str(VAFcal(bam5, chrompos_2[j])) +"\t" + str(VAFcal(bam6, chrompos_2[j])) +"\t" + str(VAFcal(bam7, chrompos_2[j])) +"\t" + str(VAFcal(bam8, chrompos_2[j])) +"\t" + str(VAFcal(bam9, chrompos_2[j])) +"\t" + str(VAFcal(bam10, chrompos_2[j])))
