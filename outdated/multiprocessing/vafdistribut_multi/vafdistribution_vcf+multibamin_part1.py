...
chrompos_1 = chrompos_split[0]

for j in range(len(chrompos_1)):
	print(str(tuple(chrompos_1[j])) +  "\t"  + str(VAFcal(bam1, chrompos_1[j])) + "\t" + str(VAFcal(bam2, chrompos_1[j])) +"\t" + str(VAFcal(bam3, chrompos_1[j])) +"\t" + str(VAFcal(bam4, chrompos_1[j])) +"\t" + str(VAFcal(bam5, chrompos_1[j])) +"\t" + str(VAFcal(bam6, chrompos_1[j])) +"\t" + str(VAFcal(bam7, chrompos_1[j])) +"\t" + str(VAFcal(bam8, chrompos_1[j])) +"\t" + str(VAFcal(bam9, chrompos_1[j])) +"\t" + str(VAFcal(bam10, chrompos_1[j])))
