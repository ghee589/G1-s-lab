...
chrompos_9 = chrompos_split[8]

for j in range(len(chrompos_9)):
	print(str(tuple(chrompos_9[j])) +  "\t"  + str(VAFcal(bam1, chrompos_9[j])) + "\t" + str(VAFcal(bam2, chrompos_9[j])) +"\t" + str(VAFcal(bam3, chrompos_9[j])) +"\t" + str(VAFcal(bam4, chrompos_9[j])) +"\t" + str(VAFcal(bam5, chrompos_9[j])) +"\t" + str(VAFcal(bam6, chrompos_9[j])) +"\t" + str(VAFcal(bam7, chrompos_9[j])) +"\t" + str(VAFcal(bam8, chrompos_9[j])) +"\t" + str(VAFcal(bam9, chrompos_9[j])) +"\t" + str(VAFcal(bam10, chrompos_9[j])))	