...
chrompos_8 = chrompos_split[7]

for j in range(len(chrompos_8)):
		print(str(tuple(chrompos_8[j])) +  "\t"  + str(VAFcal(bam1, chrompos_8[j])) + "\t" + str(VAFcal(bam2, chrompos_8[j])) +"\t" + str(VAFcal(bam3, chrompos_8[j])) +"\t" + str(VAFcal(bam4, chrompos_8[j])) +"\t" + str(VAFcal(bam5, chrompos_8[j])) +"\t" + str(VAFcal(bam6, chrompos_8[j])) +"\t" + str(VAFcal(bam7, chrompos_8[j])) +"\t" + str(VAFcal(bam8, chrompos_8[j])) +"\t" + str(VAFcal(bam9, chrompos_8[j])) +"\t" + str(VAFcal(bam10, chrompos_8[j])))