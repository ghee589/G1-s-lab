...
chrompos_7 = chrompos_split[6]

for j in range(len(chrompos_7)):
	print(str(tuple(chrompos_7[j])) +  "\t"  + str(VAFcal(bam1, chrompos_7[j])) + "\t" + str(VAFcal(bam2, chrompos_7[j])) +"\t" + str(VAFcal(bam3, chrompos_7[j])) +"\t" + str(VAFcal(bam4, chrompos_7[j])) +"\t" + str(VAFcal(bam5, chrompos_7[j])) +"\t" + str(VAFcal(bam6, chrompos_7[j])) +"\t" + str(VAFcal(bam7, chrompos_7[j])) +"\t" + str(VAFcal(bam8, chrompos_7[j])) +"\t" + str(VAFcal(bam9, chrompos_7[j])) +"\t" + str(VAFcal(bam10, chrompos_7[j])))	